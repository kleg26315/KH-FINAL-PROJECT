...
<body>
	...
	<section style="padding-top: 115px; padding-left: 20%; width: 78%; text-align: center;">
		...
		<%
			...
			String redirectURI = URLEncoder.encode("http://121.165.136.173:8780/bubblebee/callback.me", "UTF-8");
		    ...
		    Kakao.Auth.loginForm({
		      success: function(authObj) {
		        ...
		        $(function send(authObj){
		        	location.href="https://kauth.kakao.com/oauth/authorize?client_id=be0b8d3e154f1e2bf1a278bd7fbf3d2a&redirect_uri=http://121.165.136.173:8780/bubblebee/kakao.me&response_type=code";
		        });
		      },
		      fail: function(err) {
