...
<link rel = "stylesheet"  href= "<%= request.getContextPath() %>/resources/css/purchaseThis.css" type = "text/css">
		...
		<div class = "main">
			...
			<div class = "mProfile">
				<div class = "mProfileT1">
					<input class = "mProfileT11" name = "rIntro"  value = "${Board.small_title }" readonly>
						
				</div>
				<div class = "mProfileT2">
					<input class = "mProfileT21" name = "rTitle" value = "창렬회초리" readonly>
				</div>
				<div class = "mProfileT3">
					<input class = "mProfileT31" name = "rCost" value = "11,000원" readonly>
